...
/* ════════════════════════════════════════════════════════
  ...
  /* ──────────────────────────────────────────────────────
     ...
     Fuente: CEPEA (cepea.esalq.usp.br) → Indicadores → Carne bovina
             o Valor Carne Brasil → "preço arroba gancho"
             Referencia: el precio al gancho en el mercado mayorista de SP
     Publicado: semanal
     Qué cargar:
