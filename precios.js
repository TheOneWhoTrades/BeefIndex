...
/* ════════════════════════════════════════════════════════
  ...
  /* ──────────────────────────────────────────────────────
     ...
     ⚠ CUOTA APLICABLE — Set 17 cortes (ex-China):
        Argentina exporta a China bajo el régimen de los "17 cortes"
        acordados en los protocolos sanitarios bilaterales (Set 17).
        Precio de referencia: usar el precio promedio del boletín APEA
        correspondiente a estos cortes (frozen boneless, sin offal).
  ...
  /* ──────────────────────────────────────────────────────
     ...
     ⚠ CUOTA APLICABLE — Cuota TRQ (promedio general):
        Argentina exporta a EE.UU. bajo la cuota TRQ (Tariff Rate Quota)
        para carne de res fresca/congelada. No existe una cuota exclusiva
        Argentina-EE.UU.; se compite con todos los países dentro del cupo.
        Precio de referencia: usar el precio promedio CIF del boletín APEA
  ...
  /* ──────────────────────────────────────────────────────
     ...
     ⚠ CUOTA APLICABLE — Cuota Hilton (high-quality beef):
        Argentina exporta a la UE bajo la Cuota Hilton (HQBF),
        cortes enfriados de alta calidad sin hueso de novillos/vaquillonas
        alimentados a pasto. La cuota anual Argentina-UE es de ~29.500 ton
        (producto). Precio de referencia: usar el precio CIF Hilton del
        boletín APEA (sección "Cuota 481" o "Hilton"), que refleja el
  ...
  /* ──────────────────────────────────────────────────────
     ...
     ⚠ CUOTA APLICABLE — Sin cuota formal, acceso libre con requisito kosher:
        Israel no tiene un sistema de cuotas para carne argentina.
        El acceso depende de habilitación sanitaria y certificación kosher.
        Precio de referencia: usar el precio FOB a Israel del boletín APEA
        (sección "Precios FOB por destino" o "Israel") y sumar flete estimado.
